...
#curl -L https://repo.eduvpn.org/debian-stable/eduVPN.key | apt-key add -
#echo "deb https://repo.eduvpn.org/debian-stable/ stretch main" > /etc/apt/sources.list.d/LC.list
